...
cl %COMPILER_FLAGS% -I../ -I../../../include/ ../renderer_test.c ../GL/gl3w.c user32.lib shell32.lib gdi32.lib opengl32.lib ../GLFW/glfw3_vc2017_MT.lib -link -incremental:no -opt:ref
